...
class CheckoutPage(BasePage.BasePage):
  ...
  btn_done_customer_information = "button[data-test-id='ADD_ADDRESS_SUBMIT']"
  section_payment_methods = "section[data-test-id='PAYMENT_METHODS']"
  ...
  def EnterRandomCustomerInformation(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, self.btn_done_customer_information).click()
    self.wait.until_not(self.EC.text_to_be_present_in_element_attribute((By.CSS_SELECTOR, self.section_payment_methods), "class", "disabled"))

  def EnterRandomPaymentInformation(self):
